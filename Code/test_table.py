...
columns = [{"title": "Name", "field": "name", "width": 150, "headerFilter": True, "editor": "input"},
...
form = dash_tabulator.DashTabulator(id='tabulator',
                                    columns=columns,
                                    data=data,
                                    theme='materialize/tabulator_materialize', )
# options=options,
...
# dcc.Interval(id='interval-component-iu',
